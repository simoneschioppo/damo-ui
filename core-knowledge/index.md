# Core Knowledge — damacchi-ui

> Structured deep documentation of the `damacchi-ui` monorepo.
> Owned by **Kipi** (`_bmad/agents/kipi/kipi.md`). Do not hand-edit
> chapters — route every change through a Kipi workflow.
...
- 🟢 [Build and publish](10-library/30-build-and-publish/README.md)
