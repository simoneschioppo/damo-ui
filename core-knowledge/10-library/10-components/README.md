...
- 🟢 [ScrollArea](scroll-area.md) — STANDARD (Radix wrap, ink-muted bug)
...
- 🟢 [Tabs](tabs.md) — STANDARD (border-b-base bug)
...
- 🟢 [Avatar](avatar.md) — STANDARD (Radix wrap + AvatarGroup, ring-bg bug)
