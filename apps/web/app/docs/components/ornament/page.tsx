...
export default function OrnamentDocsPage() {
  return (
    <article>
      ...
      <p className="text-lg text-muted-foreground max-w-[60ch] mb-10">
        Decorative section break: two horizontal gradient hairlines flanking a centred glyph. Use
        between thematic groups inside a page where a plain{' '}
        <code className="font-mono">Separator</code> would feel too clinical.
      </p>
