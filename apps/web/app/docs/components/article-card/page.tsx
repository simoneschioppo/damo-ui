...
import { ArticleCard } from '@axologic/ui'
  ...
  return (
    <article>
      ...
      <ul className="list-disc pl-6 space-y-2 text-foreground/85">
        <li>{t.rich('componentDocs.article-card.a11y.0', { code: codeTag })}</li>
        <li>{t.rich('componentDocs.article-card.a11y.1', { code: codeTag })}</li>
      </ul>
