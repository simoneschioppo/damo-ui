  ...
  return (
    <article>
      ...
      <p className="text-lg text-muted-foreground max-w-[60ch] mb-10">
        Lightweight SVG spinner with an accessible{' '}
        <code className="font-mono">role=&quot;status&quot;</code> announcement. Use for compact,
        indeterminate loading states inside buttons, list rows or tooltips. For full bars reach for{' '}
